...
/**
 * @ORM\Entity(repositoryClass="AdmMgr\Model\Repository\StoreRepository")
 * @Gedmo\Loggable
...
class Store
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AdmMgr\Model\Entity\Group", inversedBy="stores")
     * @ORM\JoinColumn(name="groupId", referencedColumnName="id", nullable=false)
     */
    private $group;

    /**
     * @ORM\ManyToOne(targetEntity="AdmMgr\Model\Entity\User", inversedBy="ownerStores")
     * @ORM\JoinColumn(name="ownerId", referencedColumnName="id", nullable=false)
     */
    private $owner;

    /**
     * @ORM\ManyToMany(targetEntity="AdmMgr\Model\Entity\User", inversedBy="stores")
     * @ORM\JoinTable(
     *     name="UserHasStore",
