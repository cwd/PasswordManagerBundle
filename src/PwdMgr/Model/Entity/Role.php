...
/**
 * PwdMgr\Model\Entity\Role
 *
 * @ORM\Entity(repositoryClass="PwdMgr\Model\Repository\RoleRepository")
 * @Gedmo\Loggable
...
class Role
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="PwdMgr\Model\Entity\Role", mappedBy="childRoles")
     */
    private $parentRole;

    /**
     * @ORM\ManyToOne(targetEntity="PwdMgr\Model\Entity\Role", inversedBy="parentRole")
     * @ORM\JoinColumn(name="parentId", referencedColumnName="id")
     */
    private $childRoles;

    /**
     * @ORM\ManyToMany(targetEntity="PwdMgr\Model\Entity\User", inversedBy="roles", cascade={"persist","refresh"})
     * @ORM\JoinTable(
     *     name="UserHasRole",
